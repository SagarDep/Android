...
public class CropImageView extends FrameLayout implements View.OnTouchListener {
	...
	//********* Change ***********
	private final static int HEIGHT_OF_DRAGGER = 145;
	private final static int INITIAL_MARGIN_OF_DRAGGER = 160;
	//********* Change ***********
	...
	protected void onLayout( boolean changed, int left, int top, int right, int bottom ) {
		...
		if (mTopLeftDragger == null) {
			...
			//mTopLeftDragger.setImageDrawable(mDraggerDrawable); //********* Change ***********
		...
		if (mBottomRightDragger == null) {
			...
			//mBottomRightDragger.setImageDrawable(mDraggerDrawable); //********* Change ***********
